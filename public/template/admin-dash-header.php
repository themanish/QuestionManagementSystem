...
<html>
<head>
	<title>Admin : Subjects & Chapters</title>
	...
	<div class="row" id="dash-header"> 
        ...
        <div class="span4 offset4 right">
        	<div id="user-dash-logged-in" class="right">
        		<div id="user-dash-image" class="right">
        			<img src="../img/admin-profile-image.jpg" alt="User-Image" />
        		</div>
        		<div id="user-dash-info" class="left">
